...
/*                                                   +#+                      */
/*   Created: 2020/04/29 01:38:43 by abobas        #+#    #+#                 */
/*   Updated: 2020/04/29 01:38:43 by abobas        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static t_check		ft_make_precision_output(t_check check, char *temp)
{
	...
	check.arg_string = ft_str_upper(check.arg_string);
	free(temp);
	return (check);
}
...
static t_check		ft_make_precision(va_list args, t_check check)
{
	...
	{
		check.arg_string = ft_str_upper(temp);
		return (check);
	}
