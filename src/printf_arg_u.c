...
/*                                                   +#+                      */
/*   Created: 2020/04/29 01:38:15 by abobas        #+#    #+#                 */
/*   Updated: 2020/04/29 01:38:15 by abobas        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static t_check		ft_make_precision(va_list args, t_check check)
{
	...
	temp = ft_itoa_base((unsigned long)arg, 10);
	if (!temp)
		return (check);
...
t_check				ft_make_u(va_list args, t_check check)
{
	...
	else
	{
		...
		check.arg_string = ft_itoa_base((unsigned long)arg, 10);
	}
	return (check);
}
